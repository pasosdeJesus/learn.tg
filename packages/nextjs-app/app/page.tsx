    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
      <div className="relative overflow-hidden">
        ...
        <div className="space-y-4">
          ...
          Blockchain-powered education with real rewards. Study and earn scholarships as you learn.
          </p>
        </div>
        ...
        <div className="pt-8 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
          <h2 className="text-2xl font-semibold text-gray-700 mb-8">Choose Your Language</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto pt-16 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-700">
          <div className="text-center space-y-3 p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-gray-100 hover:border-primary-100 transition-all duration-300 hover:shadow-lg">
            <div className="text-4xl">🎓</div>
              <h3 className="text-lg font-semibold text-gray-800">Interactive Courses</h3>
              <p className="text-sm text-gray-600">Engaging content with quizzes and challenges</p>
            </div>
        
            <div className="text-center space-y-3 p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-gray-100 hover:border-primary-100 transition-all duration-300 hover:shadow-lg">
              <div className="text-4xl">💰</div>
              <h3 className="text-lg font-semibold text-gray-800">Earn Rewards</h3>
              <p className="text-sm text-gray-600">Get paid in USDT for completing educational guides</p>
            </div>
        
            <div className="text-center space-y-3 p-6 rounded-2xl bg-white/50 backdrop-blur-sm border border-gray-100 hover:border-primary-100 transition-all duration-300 hover:shadow-lg">
              <div className="text-4xl">🔒</div>
                <h3 className="text-lg font-semibold text-gray-800">Blockchain Secured</h3>
                <p className="text-sm text-gray-600">Transparent scholarships on Celo blockchain</p>
              </div>
            </div>
