...
const readContractMock = vi.fn().mockImplementation((opts: any) => {
  switch (opts.functionName) {
    ...
    case 'balanceOf': return Promise.resolve(1_000_000_000n) // 1000 USDT con 6 dec
...
vi.mock('wagmi', () => ({
  ...
  useWalletClient: () => ({ data: { writeContract: vi.fn().mockResolvedValue('0xhash') } }),
}))

describe('DonateModal (light)', () => {
  beforeEach(() => {
    // Variables de entorno mínimas
    ;(process as any).env.NEXT_PUBLIC_DEPLOYED_AT = '0x0000000000000000000000000000000000000001'
    ;(process as any).env.NEXT_PUBLIC_USDT_ADDRESS = '0x0000000000000000000000000000000000000002'
