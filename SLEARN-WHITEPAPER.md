...
Pricing]
    ...
    subgraph C1 [Donation Distribution: 10 USDT]
        ...
        C1_3[10%: 1 USDT → 23 SLEARN<br>Donor Reward]
...
pie
    ...
    "10% : Student Reward<br/>(1 USDT to reserve → 23 SLEARN to student)" : 10
...
- **Reserve Backing Rule** - Every SLEARN token is minted only when an
  ...
  rate of 1/23 USDT per SLEARN. For Premium Courses, a fixed 15% of each payment
...
a SLEARN: V_SLEARN​=max(FX-SLE/USD​, 1/23​) where FX-SLE/USD is the exchange rate of
SLE to USD reported the the Bank of Sierra Leone (to be presented in the
transparency dashboard) and 1/23 is upper bound of the rate in 2025.
