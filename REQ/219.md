...
In countries under persecution, publicly attesting to a leader's impact
...
- **Consent**: the witness chooses whether their testimony is public (no
  persecution) or private (aggregate score only).
