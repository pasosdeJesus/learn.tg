...
## Checklist
- [ ] Juego "El Desafío de los Siete Sellos" (Apocalipsis 5:5-6) implementado
- [ ] Distribución de preguntas en 7 grupos (sellos)
- [ ] Apertura progresiva de sellos con animación
- [ ] Botón León (verificar) y Cordero (pista/ánimo)
- [ ] Final: imagen del guía revelada al abrir el séptimo sello
- [ ] Funciona con cualquier lista de preguntas/respuestas
