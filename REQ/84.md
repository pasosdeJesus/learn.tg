...
## Checklist
- [ ] Game "The Challenge of the Seven Seals" (Revelation 5:5-6) implemented
- [ ] Questions split into 7 groups (seals)
- [ ] Progressive seal opening with animation
- [ ] Lion button (check) and Lamb button (hint/encouragement)
- [ ] Ending: the guide image revealed when the seventh seal opens
- [ ] Works with any question/answer list
