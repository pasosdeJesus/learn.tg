...
> **Motor propuesto:** identidad (futuro motor `pq-wallet` / `identity`,
> https://github.com/pasosdeJesus/learn.tg/issues/166/176/177) — **independiente de gdcluster**. La reputación de
> iglesias/pastores **no** pertenece al dominio GD.
>
> **Privacy-first (2026-08-29):** en países con persecución no se puede
> exponer públicamente la reputación (o identidad) de iglesias/pastores.
> Requisitos de diseño:
> - **Seudonimato obligatorio**: reputación bajo **alias**, sin vincular a la
>   persona/iglesia real.
> - **Agregación**: datos por cluster/país, no por persona.
> - **Datos mínimos** y capacidad de cambiar de alias/nombre.
> - Sinergia con #184 (wallet sin servidor) para no centralizar el vínculo
>   alias ↔ identidad real.
>
> **Nota (2026-08-29):** en duda cómo/dónde implementarlo — definir alcance
> junto con el motor de identidad (166/176/177); no implementar en gdcluster.
