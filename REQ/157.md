...
**Notas:** [disponible en Fase 2 vía mensajería interna — R-#162]
```
...
**Notas de pdJ:** [Fase 2 — mensajería interna R-#162]
```
...
**No `notes` or `cluster_message` columns.** Notes about GD communications are confidential — they will use the internal messaging system (R-#162 Phase 2) when available. Cluster message content is not stored; the cluster copies it to their own email. See `ARCHITECTURE.md` §Data Privacy Policy.
