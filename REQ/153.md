...
### 9.3 Premium Course Credentials & Religious Persecution

Premium course completion credentials (SBTs/NFTs) are **on-chain and public**. In countries with religious persecution, this exposes the holder as having taken a Christian course.
...
**Created:** 2026-06-29
**Status:** Pendiente — verificado 2026-08-22: sin `lib/encryption.ts`, sin columnas `encrypted_data`/`encrypted_dek`/`public_key` en `usuario`/`billetera_usuario`; los datos sensibles siguen en texto plano. Todas las fases pendientes.
