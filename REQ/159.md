...
**Opciones:**
[Deposit into Aave] [Withdraw from Aave] [View History]
...
**Next steps:**
- Funds growing while you wait for the GD director's visit
...
**Cluster:** Cluster Hope
**Billetera multisig:** 0x1234...5678

**Available to deposit:** $320.00 USDT
...
**Aave balance:** $322.15 USDT (includes $2.15 of yield)
...
> *"Aave is a protocol that lets you lend your USDT and earn interest. It is like a savings account, but on the blockchain. You can deposit and withdraw whenever you want."*

### 8.2 How to Use Aave

> *"Once you receive your cluster funds, you can deposit them in Aave so they earn yield while you wait for the Global Disciples director's visit."*

### 8.3 Risks to Understand

> *"Aave yield is variable (it can go up or down). USDT funds are stable (they do not lose value). Funds can be withdrawn at any time."*
...
**Created:** 2026-06-29
**Status:** Pendiente
**Revisión 2026-09-25 (código):** la única integración con Aave que existe son las
referencias de la skill `celopedia-skill` (material de consulta); no hay contrato, ruta ni
utilidad que invierta los fondos de cluster/país. **No cerrable:** la interfaz de
rendimiento AAVE no está empezada.
