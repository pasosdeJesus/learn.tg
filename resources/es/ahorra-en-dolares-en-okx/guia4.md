...
1. Para enviar criptoactivos de la billetera al exchange (o a otra billetera)
   presión el botón ___ (enviar)
2. En la billetera web3 de okx es donde ___ proteges la frase semilla y 
   controlas tu dinero (tu)
3. Para mover dinero del exchange OKX a tu billetera Web3 desde la pestaña
   Activos presiona el botón ___ (retirar)
