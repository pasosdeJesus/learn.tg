...
// V3 of LearnTGVaults — adds SLEARN support, uses guideId directly,
// and receives funds via recordCourseFunds() from SLEARN contract.
...
contract LearnTGVaultsV3 is ReentrancyGuard {
    ...
    /**
     * @dev Called by SLEARN contract to record funds for a course vault.
     *      USDT transferred separately by SLEARN to this contract.
     *      SLEARN minted directly to this contract by SLEARN.
     */
