...
async function main() {
  ...
  if (!fs.existsSync(deployFile)) {
    throw new Error(`ClusterFundsV2 deployment not found at ${deployFile}`);
  }
  ...
  console.log(`Verifying ClusterFundsV2 at ${addr} on ${network}`);
  ...
  console.log("ClusterFundsV2 verified!");
}
