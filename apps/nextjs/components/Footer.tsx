  ...
  return (
    <footer className="bg-gray-800 text-white py-6 relative">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-y-4 pt-4 border-t border-gray-700 text-sm text-gray-400">
          {/* Legal links — left */}
          <nav aria-label="Legal links" className="flex flex-wrap gap-x-4 gap-y-1 items-center">
            ...
            <span className="text-gray-600">|</span>
            <a href="https://t.me/learn_t_g" className="hover:text-white transition-colors">
              {t('telegram')}
            </a>
          </nav>
