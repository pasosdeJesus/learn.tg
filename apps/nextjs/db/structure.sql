...
CREATE TABLE public.cor1440_gen_proyectofinanciero (
    ...
    subtitulo character varying(1024),
    idioma character varying(6) DEFAULT 'es'::character varying NOT NULL,
    "prefijoRuta" character varying(255),
    imagen character varying(255),
    "creditoImagen" character varying(1024),
    "enlaceImagen" character varying(1024),
...
CREATE TABLE public.transaction (
    ...
    CONSTRAINT transaction_crypto_check CHECK (((crypto)::text = ANY (ARRAY[('learningpoints'::character varying)::text, ('usdt'::character varying)::text, ('celo'::character varying)::text]))),
