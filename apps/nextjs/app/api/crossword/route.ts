  ...
  try {
    ...
    if (courseId) {
      ...
      if (resolvedCourseId !== null) {
        console.log('[crossword API] Resolved courseId from prefix:', { prefix, resolvedCourseId })
      } else {
        console.log('[crossword API] Could not resolve courseId from prefix:', prefix)
      }
    }
