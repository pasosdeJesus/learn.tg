...
export default function SettingsPage({ params }: PageProps) {
  ...
  const t = useMemo(() => createComponentT(lang, {
    en: {
      ...
      credentialsHelp: 'You can revoke (burn) a credential you no longer want to publish. The credential is deleted from your profile and revoked in the blockchain (although its trace in the blockchain cannot be deleted); your progress and scholarships are kept.',
    ...
    es: {
      ...
      credentialsHelp: 'Puedes revocar (quemar) una credencial que ya no quieras publicar. Se borra de tu perfil y se revoca en la cadena de bloques (aunque su rastro en la cadena no se puede borrar); tu progreso y tus becas se conservan.',
