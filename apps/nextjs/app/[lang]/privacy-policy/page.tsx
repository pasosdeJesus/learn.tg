...
export default function PrivacyPolicyPage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const t = createComponentT(lang, {
    en: {
      ...
      item5: 'The personal information displayed in the profile page should match the internal verified information to keep your profile score.',
      item6: 'To delete verified data, click the "Delete Verified Data" button on your profile page. This immediately removes all verified fields (WhatsApp, Telegram, location, place of worship) and ID photos, changes the information displayed in your profile for arbitrary information and resets your profile score. This action cannot be undone.',
      item7: 'We cannot remove on-chain transactions or blockchain records — they are permanent and immutable. Internal logs without personal information are kept for debugging and security auditing, typically for the last 30 days.',
    },
    es: {
      ...
      item5: 'La información personal mostrada en la página de perfil debe coincidir con la información verificada interna para mantener tu puntaje de perfil.',
      item6: 'Para eliminar datos verificados, haz clic en el botón "Eliminar Información Verificada" en tu página de perfil. Esto elimina inmediatamente todos los campos verificados (WhatsApp, Telegram, ubicación, lugar de culto) y fotos de identidad, cambia la información mostrada en tu perfil por información arbitraria y restablece tu puntaje de perfil. Esta acción no se puede deshacer.',
      item7: 'No podemos eliminar transacciones en blockchain ni registros en la cadena — son permanentes e inmutables. Los registros internos sin información personal se conservan para depuración y auditoría de seguridad, típicamente de los últimos 30 días.',
    },
  })
